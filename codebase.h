...
/* 20. Cycle detection (wrappers using existing core functions) */
...
void      detectCycle_A1(void);    // wrapper for DFS (adjacency matrix)
void      detectCycle_A2(void);    // wrapper for Union-Find (edge list)
